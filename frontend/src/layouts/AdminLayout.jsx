...
const ADMIN_SEARCH_ACTIONS = [
  { id: 'dashboard', label: 'Dashboard', subtitle: 'System control center', path: '/admin/dashboard' },
...
function AdminLayoutActions() {
  ...
  const onNotificationClick = async (item) => {
    ...
    setDropdownOpen(false);
    navigate(resolveAdminNotificationRoute(item));
  };
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <Navbar title="Admin Dashboard" subtitle="Administration workspace" actions={<AdminLayoutActions />} />
